...
int main2(int numArgs, const char *args[], char *rs)
{
  ...
  {
    printf("numArgs=%d, strlen args[1]=%d \n", numArgs, (int)strlen(args[1]) );
  ...
  {
    return printf("1 Can not open input file {%s}", args[2]);
    return PrintError(rs, "1 Can not open input file ");
  }
  ...
  if (numArgs > 3)
  {
    ...
    {
      return printf("Can not open output file {%s}", args[3]);
      return PrintError(rs, "Can not open output file ");      
    }
  }
  else if (encodeMode)
  {
    printf("numArgs=%d, encodeMode=%d \n", numArgs, encodeMode);
    return PrintUserError(rs);
  }
